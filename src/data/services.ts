...
export const services: Service[] = [
  {
    ...
    metaTitle: "Web Tasarım Hizmeti | Profesyonel Web Sitesi Tasarımı",
    metaDescription:
...
- Kolay içerik yönetimi`,
...

  {
    ...
    metaTitle: "Dijital Pazarlama Hizmeti | SEO ve Sosyal Medya Yönetimi",
    metaDescription:
...
SEO ajansı mı, SEO uzmanı mı ihtiyacınız var? Sürekli, çok kanallı bir SEO yönetimi arıyorsanız SEO ajansı hizmetimiz; tek bir projede veya danışmanlık bazında birebir uzman desteği arıyorsanız SEO uzmanlarımız sizin için daha uygun olabilir. Her iki hizmet de burada anlattığımız aynı metodoloji ve ekip tarafından yürütülür.`,
...

  {
    ...
    metaTitle: "Mobil Uygulama Geliştirme | iOS ve Android Uygulamaları",
    metaDescription:
...
- Uygulama bakımı ve güncellemeleri`,
...

  {
    ...
    metaTitle: "Yazılım Geliştirme Hizmeti | Özel Yazılım Çözümleri",
    metaDescription:
...
- Teknik dokümantasyon ve eğitim`,
...

  {
    ...
    metaTitle: "E-Ticaret Web Tasarımı | Online Mağaza Kurulumu",
    metaDescription:
