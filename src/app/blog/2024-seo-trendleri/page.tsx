...
const TOC_ITEMS = [
  { id: "ai-overview", label: "1. AI Overview" },
  { id: "eeat", label: "2. E-E-A-T" },
  { id: "core-web-vitals", label: "3. Core Web Vitals" },
  { id: "sesli-arama", label: "4. Sesli Arama" },
  { id: "video-seo", label: "5. Video SEO" },
  { id: "teknik-seo", label: "6. Teknik SEO" },
  { id: "topical-authority", label: "7. Topical Authority" },
              ...
              <div className="flex gap-16 items-start">
                <div className="min-w-0 flex-1">
                  <p className="text-base md:text-lg text-gray-700 leading-relaxed border-l-4 border-red-500 pl-6 md:pl-10 py-3 mb-10">
                    ...
                    zeka entegrasyonu oldu: AI Overview (Üretken Arama
                    Deneyimi), artık sorguların önemli bir bölümünde organik
                    sonuçların üstünde yer alıyor. Bu rehberde SEO dünyasını
                    şekillendiren yedi temel trendi, ne anlama geldiklerini ve
                    sitenizi nasıl uyarlayacağınızı somut adımlarla ele aldık.
                  </p>
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        nedir?&quot; sorusunu başlıkta sorup cevabı hemen
                        altında verin.
                      </span>
                    </li>
                    <li className="flex items-start">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        Backlink inşasını ve marka bilinirliğini
                        önceliklendirin.
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        sahiplerinden geliyor. Snippet optimizasyonu hâlâ
                        geçerli.
                      </span>
                    </li>
                  </ul>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    E-E-A-T, 2022&apos;de &quot;Experience&quot; (Deneyim)
                    boyutu eklenerek güncellendi. Artık dört kriter var: Deneyim
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        gerçek bir kişi tarafından yazıldığını gösteren,
                        LinkedIn profili ve uzmanllık alanını belirten bir
                        biyografi ekleyin.
                      </span>
                    </li>
                    <li className="flex items-start">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        telefon, e-posta, şirket kaydı gibi güven sinyalleri
                        About ve iletişim sayfalarında yer almalı.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Google, 2025 yılında Core Web Vitals metrik setini
                    güncelledi. INP (Interaction to Next Paint) artık
                    FID&apos;nin yerini tamamen aldı. Mevcut metrik seti:
                  </p>
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        Hero görselini WebP formatında sunun, boyutu
                        100KB&apos;ın altında tutun
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        CDN kullanın, sunucu yanıt süresi (TTFB) &lt;600ms
                        olmalı
                      </span>
                    </li>
                    <li className="flex items-start">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-6 my-8 rounded-r-lg">
                    ...
                    <p className="text-blue-800 text-lg leading-relaxed">
                      ...
                      takip edin. Lab verisi değil, gerçek kullanıcı verisi
                      (CrUX) önemlidir.
                    </p>
                  </div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Türkiye&apos;de akıllı hoparlör kullanımı henüz düşük kalsa
                    da mobil sesli arama hızla büyüyor. Daha önemlisi,
                    Google&apos;ın doğal dil işleme gücü arttıkça yazılan
                    sorgular da giderek daha konuşma diline yaklaşıyor.
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Soru-cevap formatı kullanın:</strong>{" "}
                        &quot;[konu] nasıl yapılır?&quot;, &quot;[konu] ne
                        demek?&quot; gibi soruları başlıkta kullanıp hemen
                        altında kısa ve net bir cevap verin.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        ...
                        &quot;seo nedir&quot; yerine &quot;küçük bir işletme
                        için SEO nasıl yapılır&quot; gibi sorguları hedefleyin.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Local intent:</strong> &quot;Yakınımdaki&quot;
                        ve &quot;[şehir adı]&quot; içeren sesli aramalar yerel
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        schema ile işaretlediğinizde Google bu veriyi sesli
                        arama yanıtlarında ve featured snippet&apos;larda
                        kullanıyor.
                      </span>
                    </li>
                  </ul>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Google aramalarının %25&apos;inden fazlasında video
                    sonuçları görünüyor. Özellikle &quot;nasıl yapılır&quot; ve
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        şeması ile videoyu işaretleyin. Google bu sayfa için
                        video carousel gösterebilir.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Schema markup, Google&apos;ın içeriğinizi daha iyi
                    anlamasını sağlar ve zengin sonuçlar (rich results) elde
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    süreci&quot;, &quot;web tasarım hataları&quot;,
                    &quot;kurumsal web tasarım&quot; gibi onlarca alt konuyu
                    derinlemesine ele alan bir site, Google gözünde o alanın
                    otoritesi olarak konumlanır.
                  </p>
                  <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        Rakiplerinizin ele aldığı ama sizin henüz yazmadığınız
                        alt konuları belirleyin ve programlayın.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                  ...
                  <div className="bg-green-50 border-l-4 border-green-400 p-6 my-8 rounded-r-lg">
                    ...
                    <ul className="space-y-2 text-green-800">
                      ...
                      <li>
                        ✓ Canonical URL — Yinelenen sayfalarda canonical
                        belirtin
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-6 mb-10">
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Hayır. AI Overview&apos;da kaynak gösterilen sayfalar
                        çok daha fazla tıklama alıyor ve bu kutunun içine
                        girebilmek için yüksek kaliteli, otoriter içeriğe
                        ihtiyaç var. SEO değişiyor ama ölmüyor; aksine içerik
                        kalitesini ödüllendiren bir hal alıyor.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-3">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Yeni bir alan adı için ilk organik trafiği görmek
                        ortalama 3-6 ay sürebilir, rekabetçi anahtar kelimelerde
                        12-18 ay gerekebilir. Mevcut bir sitede teknik
                        iyileştirmeler 4-8 hafta içinde pozitif etki
                        gösterebilir.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Kelime sayısı tek başına bir sıralama faktörü değil.
                        Ancak pratik olarak yarışa girdiğiniz anahtar kelimede
                        üst sıradaki sonuçların içerik uzunluğunu analiz edin ve
                        onlarla aynı derinliği yakalayın. Rekabetçi sorgularda
                        bu genellikle 1500-3000 kelime anlamına geliyor.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-3">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        İkisi birlikte çalışır. Backlink olmadan yüksek
                        rekabetli sorgularda üst sıraya çıkmak çok zor; ama
                        içerik kalitesi düşükse backlink de değer üretmez. Önce
                        içeriği sağlama alın, ardından backlink inşa edin.
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-8">
                    ...
                    daha zekice hangi içeriğin gerçekten faydalı olduğunu
                    anlıyor. E-E-A-T&apos;yi güçlendirmek, Core Web
                    Vitals&apos;ı optimize etmek ve topical authority inşa etmek
                    bu dönemin temel stratejileridir. Profesyonel{" "}
                    <Link
                      href="/hizmetler/seo-hizmeti"
                      className="text-red-600 hover:text-red-700 font-semibold underline"
                    >
                  ...
                  <div className="text-sm text-gray-500 mt-2 mb-8">
                    Yayın tarihi: 5 Aralık 2024 • Bu yazı yazar tarafından
