...
const TOC_ITEMS = [
  { id: "marka-kimligi", label: "1. Marka Kimliği" },
  { id: "logo", label: "2. Logo Tasarımı" },
  { id: "renk", label: "3. Renk Psikolojisi" },
  { id: "tipografi", label: "4. Tipografi" },
  { id: "marka-sesi", label: "5. Marka Sesi" },
  { id: "brand-book", label: "6. Brand Book" },
  { id: "dijital-uyum", label: "7. Dijital Uyum" },
              ...
              <div className="flex gap-16 items-start">
                <div className="min-w-0 flex-1">
                  <p className="text-base md:text-lg text-gray-700 leading-relaxed border-l-4 border-red-500 pl-6 md:pl-10 py-3 mb-10">
                    ...
                    tanıdıkları ve güvendikleri markalardan alışveriş yapıyor.
                    Bu güveni inşa etmek logo, renk, tipografi, iletişim tonu ve
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Rakiplerimizden farkımız ne?</strong> UVP
                        (Unique Value Proposition)
                      </span>
                    </li>
                  </ul>
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Bu soruların yanıtları brandbook&apos;un temelini oluşturur
                    ve tüm görsel ve iletişim kararlarına rehberlik eder.
                  </p>
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        <strong>
                          Beyaz ve siyah arka planda çalışıyor mu?
                        </strong>{" "}
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        <strong>
                          5-10 yıl sonra hâlâ güncel görünecek mi?
                        </strong>{" "}
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Vurgu rengi (Accent):</strong> %10 — Dikkat
                        çeken, sınırlı kullanılan
                      </span>
                    </li>
                  </ul>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    sans-serif fontlar (Inter, Helvetica) modern ve temiz
                    duruyor. Script fontlar yaratıcı ama dikkatli kullanılmalı.
                  </p>
                  <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        + gövde fontu yeterli. Daha fazlası görsel kargaşa
                        yaratır.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Kontrast oluşturun:</strong> Başlıkta kalın
                        (bold) bir sans-serif, gövdede ince (regular) bir serif
                        iyi kontrast oluşturur.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Okunabilirlik önce:</strong> Şık ama okunaksız
                        bir font kullanıcıyı kaybettirir. Küçük ekranlarda en az
                        16px gövde boyutu.
                      </span>
                    </li>
                    <li className="flex items-start">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    her yerde arkadaşça; ama bir güvenlik açığı bildiriminde
                    biraz daha ciddidir.
                  </p>
                  <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        profesyonel, Instagram&apos;da daha samimi
                        olabilirsiniz; ama temel kişilik değişmez.
                      </span>
                    </li>
                  </ul>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Marka tutarlılığı, şirket büyüdükçe yazmak zorunda
                    kaldığınız kurallar kitabından değil, bu kuralların doğal
                    bir reflekse dönüşmesinden kaynaklanır. Ama bunu mümkün
                    kılacak ilk adım yazılı bir brandbook&apos;tur.
                  </p>
                  <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
                    Brand Book İçeriği
                  </h3>
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-6 my-8 rounded-r-lg">
                    ...
                    <p className="text-blue-800 text-lg leading-relaxed">
                      ...
                      noktalarının ekran görüntüsünü alın ve yan yana koyun.
                      Renk tutarsızlığı, farklı logo versiyonları ve değişen ton
                      anında göze çarpacak. Bu egzersiz, nerede iyileştirme
                  ...
                  <div className="space-y-6 mb-10">
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        brand book müşteri güvenini ve fiyatlama gücünü
                        artırıyor.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        kalıcı olmayı hedefliyorsanız özgün bir marka kimliği
                        için profesyonel tasarım ciddi fark yaratır. Logo
                        tasarımı tek seferlik bir yatırım; sonuçları yıllarca
                        sürer.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        İş modeliniz değiştiyse, hedef kitleniz değiştiyse,
                        mevcut kimliğiniz hedef kitlenizle uyumsuz hale geldiyse
                        veya rakiplerinizden ayırt edilemez hale geldiyse
                        yenileme zamanı gelmiştir. Acele edilmemeli; yanlış
                        zamanlı rebranding mevcut marka değerini yok eder.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-3">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        kullanıcı deneyimi de marka kişiliğini yansıtmalı:
                        premium marka daha fazla beyaz alan, basit navigasyon ve
                        kaliteli görseller kullanır; eğlenceli marka animasyon
                        ve renkli elementler tercih eder.
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-8">
                    ...
                    Müşterinin her temas noktasında tutarlı bir deneyim
                    yaşamasını sağlamak. Bu tutarlılık güven inşa eder, güven
                  ...
                  <div className="text-sm text-gray-500 mt-2 mb-8">
                    Yayın tarihi: 28 Kasım 2024 • Bu yazı yazar tarafından
