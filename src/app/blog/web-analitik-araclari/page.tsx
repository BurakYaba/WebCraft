...
const TOC_ITEMS = [
  { id: "ga4", label: "1. Google Analytics 4" },
  { id: "gsc", label: "2. Search Console" },
  { id: "hotjar", label: "3. Hotjar" },
  { id: "semrush", label: "4. SEMrush / Ahrefs" },
  { id: "metrikler", label: "5. Temel Metrikler" },
  { id: "rutin", label: "6. Analitik Rutini" },
              ...
              <div className="flex gap-16 items-start">
                <div className="min-w-0 flex-1">
                  <p className="text-base md:text-lg text-gray-700 leading-relaxed border-l-4 border-red-500 pl-6 md:pl-10 py-3 mb-10">
                    ...
                    trafik kaynağı gerçek müşteri getiriyor. Bu verileri okumak
                    ve aksiyona dönüştürmek, dijital büyümenin en hızlı yoludur.
                    Bu rehberde Google Analytics 4 kurulumundan Search Console
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    GA4, Universal Analytics&apos;ın yerini 2023&apos;te
                    devralan yeni nesil analitik platformudur. Olay tabanlı
                    (event-based) veri modeli sayesinde kullanıcı yolculuğunu
                    çok daha doğru takip ediyor.
                  </p>
                  ...
                  <ol className="space-y-4 mb-8 list-decimal pl-6">
                    <li className="text-gray-700">
                      <strong>analytics.google.com</strong>&apos;u açın →
                      Yönetici → Hesap Oluştur.
                    </li>
                    <li className="text-gray-700">
                    ...
                    <li className="text-gray-700">
                      <strong>Ölçüm ID&apos;nizi</strong> (G-XXXXXXXX)
                      kopyalayın. Next.js&apos;te bunu{" "}
                    ...
                    <li className="text-gray-700">
                      Gerçek zamanlı rapora bakarak verinin geldiğini
                      doğrulayın.
                    </li>
                  </ol>
                    ...
                    <table className="w-full border-collapse border border-gray-200 text-sm">
                      ...
                      <tbody>
                        ...
                        <tr className="bg-gray-50">
                          ...
                          <td className="border border-gray-200 px-4 py-3">
                            Ziyaretçilerin site içi yolu, hangi sayfada
                            çıktıkları
                          </td>
                          <td className="border border-gray-200 px-4 py-3">
                            Aylık
                  ...
                  <ol className="space-y-3 mb-8 list-decimal pl-6">
                    <li className="text-gray-700">
                      GA4 → Yönetici → Olaylar → Olay Oluştur adımlarını
                      izleyin.
                    </li>
                    <li className="text-gray-700">
                    ...
                    <li className="text-gray-700">
                      Oluşturduğunuz olayı &quot;Dönüşüm&quot; olarak
                      işaretleyin.
                    </li>
                    <li className="text-gray-700">
                      Raporlarda &quot;Dönüşüm Oranı&quot; sütununu ekleyerek
                      her sayfanın kaça mal olduğunu görün.
                    </li>
                  </ol>
                  ...
                  <ul className="space-y-4 mb-8">
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2 mt-1 font-bold">
                        ▸
                      </span>
                      <div>
                        ...
                        <p className="text-gray-700 mt-1">
                          Hangi sorgular için gösterildiğinizi, tıklama
                          oranınızı (CTR) ve ortalama konumunuzu görün. Tıklanma
                          oranı düşük ama yüksek sırada olan sorgular için meta
                          başlık ve açıklamanızı güçlendirin.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 mt-1">
                          ...
                          veren domainleri görün. Rakiplerinizi Ahrefs ile
                          analiz edip bu listeyi genişletebilirsiniz.
                        </p>
                      </div>
                    </li>
                  </ul>
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 mt-1">
                          ...
                          bölümünün dikkat çektiğini görün. Hizmet sayfanızda
                          CTA butonunun görünürlük alanı dışında kaldığı
                          haritada hemen belli oluyor.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 mt-1">
                          ...
                          tıklamalarını kayıt olarak izleyin. Hatalı bağlantı
                          veya kırık öğeleri bu yöntemle tespit ettik.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    Ahrefs rakiplerinizin verisini görmenizi sağlar. Hangi
                    anahtar kelimelerden organik trafik aldıklarını, backlink
                    profillerini ve içerik boşluklarını ortaya çıkarır.
                  </p>
                  <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
                  ...
                  <ol className="space-y-3 mb-8 list-decimal pl-6">
                    ...
                    <li className="text-gray-700">
                      &quot;Organic Keywords&quot; raporunda rakibin trafik
                      aldığı ama sizin almadığınız anahtar kelimeleri belirleyin
                      (Keyword Gap özelliği).
                    </li>
                    <li className="text-gray-700">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Veri bolluğu içinde kaybolmamak için hangi metriğin ne
                    anlama geldiğini ve ne zaman endişe duymanız gerektiğini
                    bilmek önemlidir.
                  </p>
                  <div className="overflow-x-auto mb-8">
                    <table className="w-full border-collapse border border-gray-200 text-sm">
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        <strong>Her gün (5 dk):</strong> GA4 gerçek zamanlı
                        raporu — aktif kullanıcı sayısı ve dönüşümler
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Her hafta (30 dk):</strong> GSC Performans
                        raporu — tıklama, gösterim, CTR değişimleri
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Her hafta (20 dk):</strong> GA4 Kullanıcı
                        Edinimi — hangi kanal büyüyor / azalıyor?
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span className="text-gray-700">
                        <strong>Her ay (1 saat):</strong> Hotjar kayıtları
                        gözden geçirme ve funnel analizi
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                  ...
                  <div className="space-y-6 mb-10">
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        olan kurumsal kullanıcılar için ücretli GA4 360
                        versiyonu mevcuttur.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Varsayılan olarak 2 aydır. Yönetici → Veri Ayarları →
                        Veri Saklama bölümünden 14 aya çıkarabilirsiniz. Özel
                        raporlarda tarih aralığı bu süreyle sınırlıdır; bu
                        nedenle mümkün olan en kısa sürede 14 aya çıkarmanızı
                        öneririz.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        GSC yalnızca Google organik tıklamalarını sayarken GA4
                        tüm kanalları dahil eder. Ayrıca GSC bot ve spam
                        filtresi uygular; GA4 ise varsayılan olarak daha
                        kapsamlı izler. Küçük farklılıklar normaldir; büyük
                        (%30+) farklılıklar GA4&apos;te filtre hatası veya çift
                        etiket varlığına işaret edebilir.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-3">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        politikanızda analitik çerezlere onay alınmasını
                        öneririz.
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-8">
                    ...
                    hizmeti ile bu süreçleri sizin için yönetiyoruz. WebCraft
                    ile iletişime geçin.
                  </p>
                  {/* Author Bio */}
                  ...
                  <div className="text-sm text-gray-500 mt-2 mb-8">
                    Yayın tarihi: 22 Kasım 2024 • Bu yazı yazar tarafından
