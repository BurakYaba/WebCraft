...
const TOC_ITEMS = [
  { id: "ssl", label: "1. SSL / HTTPS" },
  { id: "waf", label: "2. WAF" },
  { id: "guvenlik-basliklari", label: "3. Güvenlik Başlıkları" },
  { id: "kimlik-dogrulama", label: "4. Kimlik Doğrulama" },
  { id: "yedekleme", label: "5. Yedekleme" },
  { id: "cms-guvenligi", label: "6. CMS Güvenliği" },
  { id: "ddos", label: "7. DDoS Koruma" },
              ...
              <div className="flex gap-16 items-start">
                <div className="min-w-0 flex-1">
                  <p className="text-base md:text-lg text-gray-700 leading-relaxed border-l-4 border-red-500 pl-6 md:pl-10 py-3 mb-10">
                    2025 yılında dünya genelinde her 39 saniyede bir siber
                    saldırı gerçekleşiyor. Küçük işletmelerin hedef alınma oranı
                    tüm saldırıların %43&apos;ünü oluşturuyor. Web sitesi
                    güvenliği artık büyük şirketlerin sorunu değil; bir iletişim
                    formu barındıran her web sitesi potansiyel hedeftir. Bu
                    rehberde, teknik detayları atlayan değil, adım adım
                    uygulayabileceğiniz somut önlemleri ele aldık.
                  </p>
...
RewriteRule ^(.*)$ https://%{HTTP_HOST}%{REQUEST_URI} [L,R=301]`}</pre>
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 mt-1">
                          DNS&apos;inizi Cloudflare&apos;e yönetin. Ücretsiz
                          plan bile DDoS koruma, HTTPS ve temel WAF kuralları
                          sunuyor. Pro plan ($20/ay) daha gelişmiş WAF kuralları
                          içeriyor.
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 mt-1">
                          Cloud altyapısı kullanan kurumsal projeler için
                          managed WAF çözümleri. IP blocklist, rate limiting ve
                          bot yönetimi içeriyor.
                        </p>
                      </div>
                    </li>
                  </ul>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    etkili ve çoğu zaman göz ardı edilen bir güvenlik
                    katmanıdır.
                  </p>
                  <div className="bg-gray-900 text-green-400 rounded-xl p-4 mb-6 overflow-x-auto text-sm font-mono">
...
},
{
  ...
  value: 'camera=(), microphone=(), geolocation=()'
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        verir. Bir kez ayarlandı mı, HTTPS olmadan bağlantı
                        kabul edilmez.
                      </span>
                    </li>
                    <li className="flex items-start">
                  ...
                  <p className="text-gray-700 mb-6">
                    ...
                    snapshot&apos;ları tutar. Veritabanı olan projelerde ek
                    olarak AWS S3, Backblaze veya Google Cloud Storage&apos;a
                    günlük otomatik dump gönderin.
                  </p>
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        yıldır güncellenmemiş, az indirilen eklentilerden
                        kaçının. WPScan veya Wordfence ile tarama yapın.
                      </span>
                    </li>
                  </ul>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    DDoS (Distributed Denial of Service), sunucunuza normalin
                    çok üzerinde istek göndererek sitenizi çevrimdışı bırakan
                    saldırı türüdür. E-ticaret siteleri en sık hedeflenenler
                    arasında.
                  </p>
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                  ...
                  <div className="bg-red-50 border-l-4 border-red-400 p-6 my-8 rounded-r-lg">
                    ...
                    <ul className="space-y-2 text-red-800">
                      <li>
                        ✓ SSL sertifikası kurulu ve HTTP → HTTPS yönlendirme
                        aktif
                      </li>
                      <li>
                  ...
                  <div className="space-y-6 mb-10">
                    ...
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        küçük siteleri hedef alıyor. Küçük siteler spam
                        göndermek, kripto para madenciliği yapmak veya başka
                        sitelere saldırmak için &quot;aracı&quot; olarak
                        kullanılıyor. Siteniz hacklense bile müşteri fırsatı
                        kaybediyorsunuz.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        zorunluluğunu karşılar. Form güvenliği, veri
                        minimizasyonu (yalnızca gerekli veri toplama) ve veri
                        ihlali bildirim prosedürü KVKK uyumunun temel
                        bileşenleridir.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        açığını kapatın (güncel olmayan eklenti, zayıf şifre
                        vb.). 6) Google Search Console&apos;dan &quot;Güvenlik
                  ...
                  <div className="text-sm text-gray-500 mt-2 mb-8">
                    Yayın tarihi: 25 Kasım 2024 • Bu yazı yazar tarafından
