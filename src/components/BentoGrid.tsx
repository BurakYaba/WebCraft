...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/30 to-black/80 opacity-60 group-hover:opacity-90 transition-opacity duration-500" />
